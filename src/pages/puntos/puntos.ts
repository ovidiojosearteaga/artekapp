...
export class PuntosPage {
  ...
  ionViewDidEnter() 
  {
    ...
    this.restProvider.getWordpressUserData(this.userDataProvider.getUserId())
      .then( data => {
        this.userData = data; 
        console.log(this.userData.user_points);
        this.userDataProvider.getUserData().user_points = this.userData.user_points;
